...
tests against every entry point in the application. To do this, you 
would typically submit:
...
- OAST payloads designed to trigger an out-of-band network
interaction when executed within a SQL query, and monitor any resulting
interactions.
